...
con_string = "mongodb+srv://Mahiladevi:MahimaSanjuma2925@cluster0.z05rdth.mongodb.net/?retryWrites=true&w=majority"

client = pymongo.MongoClient(con_string)

db = client.get_database('firstdatabase')

user_collection = pymongo.collection.Collection(db, 'firsrcollection') #(<database_name>,"<collection_name>")
